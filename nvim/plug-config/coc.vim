...
" Add `:Hover` command for show preview documentation
...
command! -nargs=0 EslintEnable :CocCommand eslint.enable

" jsonc - add correct comment highlighting
