...
- [[#lsp--diagnostics--formatting][Lsp + Diagnostics + Formatting]]
  ...
  - [[#eglot][Eglot]]
  - [[#lsp-mode-tangle-no][LSP-Mode (:tangle no)]]
...
- [[#wgrep][Wgrep]]
- [[#vterm-todo-make-consult-shortcuts-work-in-vterm][Vterm (TODO: make consult shortcuts work in vterm)]]
- [[#org-mode-1][Org Mode]]
- [[#sudo][Sudo]]
- [[#undo-tree][Undo Tree]]
...
* Vterm (TODO: make consult shortcuts work in vterm)
